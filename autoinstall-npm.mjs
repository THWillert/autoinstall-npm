...
/**
 * Sicheres Einlesen einer Datei aus einem Basisverzeichnis.
 *
 * @param {string} filePath - Relativer Pfad zur Datei.
 * @param {string} baseDir - Basisverzeichnis, innerhalb dessen gelesen werden darf.
 * @param {string} [encoding='utf8'] - Encoding für den Dateiinhalt.
 * @returns {Promise<string>} - Inhalt der Datei.
 * @throws {Error} Wenn Path Traversal erkannt oder die Datei nicht existiert.
 */
async function safeReadFile(filePath, baseDir, encoding = 'utf8') {
...
async function findRequiredPackages(filePath, baseDir) {
    const fileContent = await safeReadFile(filePath, baseDir);
